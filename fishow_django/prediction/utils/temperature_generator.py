...
class TemperatureTextGenerator:
    template_text_one = '''Температура воздуха несильно влияет на клев рыбы, однако при резком понижении или повышении температуры воздуха прогноз клева может изменится. Это можно объяснить тем, что температура воздуха влияет на клев рыбы косвенно через температуру воды. Поэтому при небольших колебаниях температуры воздуха температура воды не успевает изменится настолько, чтобы повлияет на клев в тот промежуток времени, по которому делается прогноз нашей моделью. '''

    template_text_ten = '''Температура воздуха несильно влияет на клев рыбы, однако при резком понижении или повышении температуры воздуха прогноз клева может изменится. Это можно объяснить тем, что температура воздуха влияет на клев рыбы косвенно через температуру воды. Поэтому при небольших колебаниях температуры воздуха температура воды не успевает изменится настолько, чтобы повлияет на клев в тот промежуток времени, по которому делается прогноз нашей моделью. '''
