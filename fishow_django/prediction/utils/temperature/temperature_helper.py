...
not_influence_text = '''Температура воздуха оказывает значительное влияние на клев в случае резких перепадов температуры. В случае же небольших изменений температуры воздуха клев <strong>{}</strong> может изменится за счет других факторов. '''
...
none_fish = '''На данный момент точно неизвестно, как именно влияет изменения температуры воздуха на клев <strong>{}</strong>. '''
