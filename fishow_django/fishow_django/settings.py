...
DEFAULT_PATH_TO_BACK_MEDIA = 'https://back.fishow.ru/media/'
DEFAULT_PATH_TO_USER_IMAGE = 'users/2021/04/02/05/02/03/vl5za2.png'
...
THUMBNAILS = {
    ...
    'SIZES': {
        ...
        'large': {
            'PROCESSORS': [
                {'PATH': 'thumbnails.processors.resize', 'width': 128, 'height': 128},
                {'PATH': 'thumbnails.processors.flip', 'direction': 'horizontal'}
            ],
        }
    }
