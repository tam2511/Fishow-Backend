                ...
                <div class="container">
                    <div class="row row-50 justify-content-center justify-content-lg-between">
                        <div class="col-md-4 col-lg-5 col-xxl-4 text-center text-lg-left">
                            ...
                            <div class="group-md group-middle"><a class="button button-sm button-gray-outline" href="{% url 'contact_us' %}">Социальные сети</a>
                            ...
                            <div class="wrap-posts-classic">
                                ...
                                <article class="post-classic">
                                    <div class="post-classic-main">
                                        <p class="post-classic-title"><a href="{% url 'blog_post' %}">Which team will win the world championship series this year?</a></p>
                        ...
                        <div class="col-10 col-md-4 col-lg-3">
                            ...
                            <ul class="list-md">
                                <li class="unit unit-horizontal align-items-center">
                                    ...
                                    <div class="unit-body">
                                        <h6>Присоединится</h6><a class="link" href="mailto:#">team@demolink.org</a>
                                    </div>
                                </li>
                                <li class="unit unit-horizontal align-items-center">
                                    <div class="unit-left">
                                    ...
                                    <div class="unit-body">
                                        <h6>Контакты</h6><a class="link" href="mailto:#">team@demolink.org</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
