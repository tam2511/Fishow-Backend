...
(function () {
	...
	$(function () {
		...
		// 		if ( ( !this.hasClass( 'lazy-loaded' ) && ( isScrolledIntoView( this ) ) ) ) {
		// 			func.call( this );
		// 			this.addClass( 'lazy-loaded' );
		// 		}
		// 	};
		//
		// 	scrollHandler.call( element );
		// 	$window.on( 'scroll', scrollHandler.bind( element ) );
		// }
		...
		// 	plugins.customIFrame = $('iframe[data-src]');
		//
		// 	for (var i = 0; i < plugins.customIFrame.length; i++) {
		// 		lazyInit( $(plugins.customIFrame[i]), function () {
		// 			console.log( 'cp0', this );
