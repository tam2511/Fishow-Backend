        ...
        <div class="container">
          ...
          >
            <div class="col-md-4 col-lg-5 col-xxl-4 text-center text-lg-left">
              <article
                class="unit flex-column flex-lg-row align-items-center justify-content-center justify-content-sm-start footer-creative-info"
              >
                <div class="unit-left">
                  <router-link class="brand brand-md" to="/"
                    ><img
                ...
                <div class="unit-body">
                  <p>
                    Dragons provides extensive information on everything
                    concerning our basketball team for fans all over the world.
                  </p>
                </div>
              </article>
              <div class="group-md group-middle">
                ...
                <div class="align-items-center">
                  <ul class="list-inline list-inline-xs">
                    ...
                    <li>
                      <a class="icon icon-corporate fa fa-twitter" href="#"></a>
                    </li>
                    <li>
                      <a
                        class="icon icon-corporate fa fa-google-plus"
                        href="#"
                      ></a>
                    </li>
                    <li>
                      <a
                        class="icon icon-corporate fa fa-instagram"
                        href="#"
                      ></a>
                    </li>
                  </ul>
            ...
            <div class="col-10 col-md-4 col-lg-3">
              ...
              <ul class="list-md">
                <li class="unit unit-horizontal align-items-center">
                  <div class="unit-left">
                    <svg
                      class="svg-color-abbey svg-sizing-35"
                      x="0px"
                      y="0px"
                      width="27px"
                      height="27px"
                  ...
                  <div class="unit-body">
                    <h6>Присоединится</h6>
                    <a class="link" href="mailto:#">team@demolink.org</a>
                  </div>
                </li>
                <li class="unit unit-horizontal align-items-center">
                  <div class="unit-left">
    ...
    <div class="footer-creative-aside footer-creative-darken">
      <div class="container">
        <div class="layout-justify">
          ...
          <!-- Rights-->
          <p class="rights">
            <span>Fishow</span><span>&nbsp;&copy;&nbsp;</span
